...
print("---- 测试输出结果 -----")
for i in MuFullList:
    if  (MuFullList.index(i)+1) % 20 == 0 and MuFullList.index(i)>0:
        print(str(MuFullList.index(i)+1)+":"+i.zi+str(i.bihua)+"画")
    elif (MuFullList.index(i)+1) != len(MuFullList):
        print(str(MuFullList.index(i)+1)+":"+i.zi+str(i.bihua)+"画"+",",end="")
    else:
        print(str(MuFullList.index(i) + 1) + ":" + i.zi+str(i.bihua)+"画", end="")
