...
def InitMuData(ChineseCharSet_Mu):
    ...
    charstring_02 = "棒,笔,草,策茨,答,等,棣,迭,筏,给,贯,贵,皓,荒,集,几,悸,间,荐,杰,景,凯,棚,期,棋,强,乔,球,荏,茸,茹,森,棠,统,稀,雅,茵,硬,驭,棕,椎,最"
    charstring_03 = "棒,笔,草,策茨,答,等,棣,迭,筏,给,贯,贵,皓,荒,集,几,悸,间,荐,杰,景,凯,棚,期,棋,强,乔,球,荏,茸,茹,森,棠,统,稀,雅,茵,硬,驭,棕,椎,最"
    charstring_04 = ""
    ...
    charstring_02 = "梓,筹,继,舰,藉,觉,跨,馈,蓝,篮,琼,献,议"
    charstring_03 = "梓,筹,继,舰,藉,觉,跨,馈,蓝,篮,琼,献,议"
    charstring_04 = ""
