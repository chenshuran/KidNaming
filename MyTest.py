...
def MyInitData():
    ...
    #     elif (HuoFullList.index(i)+1) != len(HuoFullList):
    #         print(str(HuoFullList.index(i)+1)+":"+i.zi+str(i.bihua)+"画"+",",end="")
    #     else:
    #         print(str(HuoFullList.index(i) + 1) + ":" + i.zi+str(i.bihua)+"画", end="")
