...
def InitMuData(ChineseCharSet_Mu):
    ...
    charstring_02 = "竿,枸,故,冠,轨,柜,级,既,建,皆,界,劲,久,看,科,客,柳,恰,芊,俏,芍,玩,侠,桐,彦,奕,弈,羿,栅,枳,柱"
    charstring_03 = "竿,枸,故,冠,轨,柜,级,既,建,皆,界,劲,久,看,科,客,柳,恰,芊,俏,芍,玩,侠,桐,彦,奕,弈,羿,栅,枳,柱"
    charstring_04 = "革,故,冠,癸,虹,纪,既,建,皆,界,劲,九,拒,军,看,柯,科,客,芝,柳,祈,俏,酋,柿,侠,相,彦,奕,弈,羿,柚,禺,栅,斫,柱"
    ...
    charstring_02 = "枫,该,概,跟,荷,逅,楫,栋,睫,解,仅,禁"
    charstring_03 = "枫,该,概,跟,荷,逅,楫,栋,睫,解,仅,禁"
    charstring_04 = "枫,概,感,跟,荷,减,睫,解,仅,禁,靳,经,筠,慨,楷,廉,琨"
    ...
    charstring_02 = "榜,尝,菲,嘉,笺,箏,酷,魁,荫,幕,裴,侨,轻,箐,荣,榕,瑟,菽,菘,算,榫,榻,葡,箫,榭,语,愿,肇"
    charstring_03 = "榜,尝,菲,嘉,笺,箏,酷,魁,荫,幕,裴,侨,轻,箐,荣,榕,瑟,菽,菘,算,榫,榻,葡,箫,榭,语,愿,肇"
    charstring_04 = "榜,萃,菲,盖,纲,歌,管,赫,嘉,戬,竭,兢,榛,魁,菱,裴,旗,绮,侨,轻,箐,荣,榕,菀,箫,语,愿,肇"
    ...
    charstring_02 = "葆,标,枞,稻,蒂,稿,葛,庚,巩,广,驾,俭,慷,庆,枢,葶,苇,贤,样,仪,谊,毅,莹"
    charstring_03 = "葆,标,枞,稻,蒂,稿,葛,庚,巩,广,驾,俭,慷,庆,枢,葶,苇,贤,样,仪,谊,毅,莹"
    charstring_04 = "葆,标,枞,稻,樊,葛,赓,巩,广,郭,驾,稼,翦,桨,槿,儆,慷,课,萱,箴,宽,模,庆,葶,葳,苇,贤,样,仪,谊,毅,莹,樟,著"
    ...
    # 16画木字
    charstring_01 = "蓓,荜,筚,蓖,篦,蔀,篰,苍,橙,篘,莼,笃,饿,谔,鄂,阏,萼,遏,噩,蒽,篚,噶,篙,糕,缟,膈,骼,鸪,毂,掼,龟,辊,过,蒿,嚆,横,黉,骺,鲎,桦,慌,隍,荤,机,畿,墼,蒺,剂,冀,髻,颊,缣,蒹,谏,踺,彊,耩,犟,挢,徼,缙,噤,颈,憬,橘,举,踽,窭,鄄,橛,麇,瞰,眍,篥,蓄,蓁,蒸,裤,哙,窥,愦,梦,蒲,朴,器,褰,黔,橇,桥,憔,樵,撬,鞘,亲,擒,檎,螓,檠,磬,遒,鼽,糗,趋,鸲,磲,桡,蓉,蓐,穑,树,蒴,蒜,荪,蓑,蓊,樨,县,橡,筱,啸,谐,阎,谚,窑,缢,荫,萦,蓥,嬴,颖,阈,遇,圜,樾,筑,篆,嘴,樽"
    charstring_02 = "蓓,苍,笃,过,憬,憬,举,梦,朴,器,桥,樵,亲,蓉,树,啸,颖,遇,筑,樽"
    charstring_03 = "蓓,苍,笃,过,憬,憬,举,梦,朴,器,桥,樵,亲,蓉,树,啸,颖,遇,筑,樽"
    charstring_04 = "蓓,苍,橙,萼,过,桦,机,冀,谏,彊,颈,憬,举,蓄,蓁,蒸,梦,蒲,朴,桥,樵,磬,趋,蓉,啸,谐,谚,颖,遇,樾,筑,樽"
    ...
    charstring_04 = "蔡,苁,玑,讲,蒋,联,蔻,谦,芗,营,岳"
    ...
    charstring_04 = "关,襟,旷,鲲,扩,蕾,枥,栎,橹,麓,麒,萧,薛"
...
def InitHuoData(ChineseCharSet_Huo):
    ...
    charstring_03 = "驰,传,搭,当,鼎,督,煌,煌,幌,迹,炼,路,农,暖,提,烟,扬,照,琢"
    charstring_04 = ""
