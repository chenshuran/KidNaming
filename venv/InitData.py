...
def InitHuoData(ChineseCharSet_Huo):
    ...
    charstring_04 = "炳,待,段,赴,柬,炯,俊,亮,俐,律,珏,耐,南,泰,亭,炫,映,昱,招,昭,者,贞,祉,致,重,炷,奏,拓"
    ...
    charstring_04 = "瑾,达,导,道,积,琏,璇,臻,历,龙,卢,陆,录,诺,燃,陶,熹,晓,晔,遂,陵,骆,璋,烨"
    ...
    charstring_04 = "瞻,丛,戴,焘,丰,职,礼,适,曙,题,曜"
