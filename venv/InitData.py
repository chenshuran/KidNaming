...
def InitMuData(ChineseCharSet_Mu):
    ...
    # charstring_02 = "竿,枸,故,冠,轨,柜,级,既,建,皆,界,劲,久,看,科,客,柳,恰,芊,俏,芍,玩,侠,桐,彦,奕,弈,羿,栅,枳,柱" 此处有误，久为3画，桐为10画
    # charstring_03 = "竿,枸,故,冠,轨,柜,级,既,建,皆,界,劲,久,看,科,客,柳,恰,芊,俏,芍,玩,侠,桐,彦,奕,弈,羿,栅,枳,柱"  此处有误，久为3画，桐为10画
    ...
    charstring_04 = "枫,感,荷,睫,解,禁,靳,经,筠,慨,楷,廉,琨"
    ...
    charstring_04 = "榜,萃,菲,盖,纲,歌,管,赫,嘉,魁,菱,裴,旗,绮,侨,轻,箐,荣,榕,菘,菀,箫,语,愿,肇"
...
def InitHuoData(ChineseCharSet_Huo):
    ...
    charstring_04="尺,丹,斗,火,支,内,太,天,午,中,之"
    ...
    charstring_04 = "代,旦,冬,立,令,另,冉,田,召,左,台"
    ...
    charstring_04 = "采,呈,良,李,利,伶,吕,男,努,廷,托,志,住,灼,足"
    ...
    charstring_04 = "彤,佰,长,岱,狄,两,底,到,典,定,炅,昊,攸,弢,争,政,知,直,昆,来,仑,旻,念,昕,炎,易,制,忠,卓"
    ...
    charstring_04 = "炳,待,段,赴,柬,炯,俊,亮,俐,律,娜,耐,南,泰,亭,炫,映,昱,招,昭,者,贞,祉,致,重,炷,奏"
    ...
    charstring_04 = "从,凑,给,带,袋,胆,顶,舵,烽,将,梁,振,执,鹿,晟,张,章"
    ...
    charstring_04 = "焙,采,场,程,单,登,迪,敦,焦,接,晶,就,量,证,琅,理,琉,闰,婷,循,巽,轴,媛,智"
    ...
    charstring_04 = "际,辽,郑,离,丽,庞,烁,谭,韬,绎,赠"
